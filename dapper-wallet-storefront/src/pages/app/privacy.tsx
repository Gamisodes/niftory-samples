      ...
      <VStack className="mx-auto">
        <div className="text-white">
          ...
          <div className="text-xl">
            ...
            <p className="pb-3">
              We reserve the right to make any changes to our Privacy Policy at any time, notice of
              which may be posted on this privacy page at https://gamisodes.com/privacy.
            ...
            <p className="pb-4">
              ...
              personally identifiable information. This refers to information about you that can be
              used to contact or identify you (“Personal Information”).
              <span className="Apple-converted-space">&nbsp; </span>
              ...
              provide or publicly available through your NFT. We may also collect any communications
              between you and Gamisodes, as well as any information you provide if you take part in
              any interactive features of the Service (e.g., games, contests, promotions, surveys,
              etc.). <span className="Apple-converted-space">&nbsp; &nbsp;</span>
            </p>
            <p className="pb-4">
              Usage Data.<span className="Apple-converted-space">&nbsp; </span>Besides the Personal
              information, we may also collect other information regarding your activity during your
              use of the Service including, but not limited to, session duration, time between
              sessions, searches made during a session, actions taken, log in time, log out time,
              and other behavioral data (collectively, “Usage Information”).{" "}
              <span className="Apple-converted-space">&nbsp;</span>
            </p>
            <p className="pb-5">
              ...
              <span className="Apple-converted-space">&nbsp; </span>
              This information may include, but is not limited to, your computer’s Internet Protocol
              address (IP address) or other identifier, your general location, browser type, the web
              pages you were visiting before you came to the Service, and in-bound tracking, namely,
              the source (ad, social media channel or blog, search engine) which made you aware of
              the Service. <span className="Apple-converted-space">&nbsp;</span>
            </p>
            <p className="pb-4">
              ...
              <span className="Apple-converted-space">&nbsp; </span>We may also collect and use any
              files that you send to us for troubleshooting in order to improve our Service.{" "}
              <span className="Apple-converted-space">&nbsp;</span>
            </p>
            <p className="pb-4 text-2xl">
            ...
            <p className="pb-4">
              ...
              (including data analytics), (ii) to respond to your submissions, questions, comments,
              requests and complaints and provide customer service; (iii) as part of our efforts to
              keep the Service and integrations safe and secure; (iv) to protect Gamisodes’s rights
              or property; (v) for internal operations, including troubleshooting, data analysis,
              testing, research, customization, and improvements to service and experience on the
              Service; (vi) to send you confirmations, updates, security alerts, and support and
              administrative messages; and (vii) for any other legitimate business purpose for which
              the information was collected.
              <span className="Apple-converted-space">&nbsp; </span>We may use information to
              provide online advertising on the Service and to send you information we think may be
              useful or relevant to you.<span className="Apple-converted-space">&nbsp;</span>
            </p>
            <p className="pb-3">
            ...
            <p className="pb-3">
              ...
              <span className="Apple-converted-space">&nbsp; </span>For example, third-party wallet
              providers provide us with your blockchain address and certain other information you
              choose to share with those wallets providers. We may add this to the data we have
              already collected from or about you through our Service.
              <span className="Apple-converted-space">&nbsp;</span>
            </p>
            <p className="pb-4">
              Gamisodes may on occasion combine information collected with additional records (such
              as information from affiliated companies, partners, distributors, or outside vendors,
              and publicly available information, including on social media sites).
              <span className="Apple-converted-space">&nbsp; </span>The combined information may be
              used for purposes such as to market products, features, or services that may be of
              interest to you, or for research and analytics.
            </p>
            <p className="pb-4 text-2xl">
              <b>Sharing Information with Third Parties</b>
            </p>
            <p className="pb-4">
              Gamisodes may share your information: (i) where your consent is obtained, such as when
              you choose to opt-in to the sharing of data; (ii) with vendors and service providers
              retained in connection with provision of the Service, including for data analytics
              purposes (iii) to comply with law enforcement requests and legal process (such as a
              court order or subpoena) legal action or law enforcement (“Legal Reasons”); (iv) to
              enforce or apply this Privacy Policy, our{" "}
              <a href="https://gamisodes.com/pages/terms">
                <span className="s1">Terms of Service</span>
              </a>{" "}
              or our other policies or agreements; (v) respond to your requests; (vi) protect
              Gamisodes’s, your, or others’ legal rights and/or property (“Prevent Harm”); or (vii)
              if Gamisodes is involved in a merger, acquisition or asset sale, in which case the use
              of your information will be governed by the provisions of this Privacy Policy in
              effect at the time Gamisodes collected such information. One of the service providers
              that we use for data analytics is Google Analytics. If you do not want Google
              Analytics to collect and use information about your use of the Service, then you can
            ...
            <p className="pb-4">
              Email Communications.<span className="Apple-converted-space">&nbsp; </span>We may send
              you newsletters or promotional communications, and you may indicate a preference to
              stop receiving these communications from us by following the unsubscribe instructions
              provided in the email you receive or by altering your account settings.
              <span className="Apple-converted-space">&nbsp; </span>Even if you opt out of marketing
              or promotional communications, we may send you occasional transactional
            ...
            <p className="pb-4">
              ...
              by changing its settings, to stop accepting Cookies or to prompt you before accepting
              a Cookie from the websites you visit. Consult your browser’s technical information. If
            ...
            <p className="pb-4">
              Data Access and Control.<span className="Apple-converted-space">&nbsp; </span>You can
              view, access, edit, or delete your Personal Information for certain aspects of the
              Service via your Settings page.<span className="Apple-converted-space">&nbsp; </span>
            ...
            <p className="pb-4">
              If you wish to exercise your rights under the GDPR or other applicable data protection
              or privacy laws, please contact us at hello@gamisodes.com with the subject “Data
              Privacy Request”, specify your request, and reference the applicable law. We may ask
              you to verify your identity or ask for more information about your request. We will
            ...
            <p className="pb-4">
              ...
              blockchain as we do not have custody or control over any blockchains. The information
              stored on the blockchain may include purchases, sales, and transfers related to your
            ...
            <p className="pb-4">
              Gamisodes does not control the privacy policies of third parties, and you are subject
              to the privacy policies of those third parties where applicable.
              <span className="Apple-converted-space">&nbsp; </span>Gamisodes is not responsible for
              the privacy or security practices of other websites on the Internet, even those linked
              to or from the Gamisodes site.<span className="Apple-converted-space">&nbsp; </span>We
              encourage you to ask questions before you disclose your personal information to
              others.
            </p>
            <p className="pb-4">
              ...
              services on our behalf, to perform Website-related services (including but not limited
              to maintenance services, database management, web analytics and improvement of
              Gamisodes’s features) or to assist us in analyzing how our Website and Service are
              used and can be improved. These third parties may have access to your Personal
            ...
            <p className="pb-4">
              ...
              <span className="Apple-converted-space">&nbsp; </span>To the maximum extent allowable
              by law, the Privacy Policy will apply to the User information as transferred to the
              successor entity.<span className="Apple-converted-space">&nbsp; </span>However, User
              information submitted after a transfer to a successor entity may be subject to a new
            ...
            <p className="pb-4">
              ...
              <span className="Apple-converted-space">&nbsp; </span>It is important that you protect
              against unauthorized access of your account and information by choosing your password
              carefully and keeping your password and computer secure by signing out after using our
              services.
            ...
            <p className="pb-4">
              ...
              information when you sign in; keep track of preferences you specify; display the most
              appropriate content based on your interests and activity on Gamisodes; estimate and
              report Gamisodes's total audience size and traffic; conduct research to improve our
              content and services. <span className="Apple-converted-space">&nbsp;</span>
            </p>
            <p className="pb-4">
            ...
            <p className="pb-4">
              ...
              technologies, such as browser cookies or Flash cookies, to provide certain services or
              features. These technologies allow a partner to recognize your computer each time you
              visit Gamisodes, but do not allow access to personally identifiable information from
              Gamisodes.
              ...
              depending on the browser used, but generally can be found by using the “Help” feature
              available on your browser.<span className="Apple-converted-space">&nbsp; </span>
            ...
            <p className="pb-4">
              Gamisodes will retain your Personal Information for as long as your account is active
            ...
            <p className="pb-4">
              ...
              that a child under thirteen (13) has provided us with personal information (beyond the
              Required Information) without our obtaining Parental Consent, please contact us
              ...
              reasonably necessary for that participation, and we do not retain Personal Information
              from children under thirteen (13) longer than is reasonably necessary in order to
              fulfill the purpose for which it was disclosed.
            </p>
            <p className="pb-4">
              If you are a parent or guardian of a child under thirteen (13), you have the right to
              request that we allow you to review, modify or delete your child's personal
            ...
            <p className="pb-4">
              ...
              <span className="Apple-converted-space">&nbsp; </span>If you are a user accessing the
              Service from the European Union, Australia, Asia, or any other region with laws or
              regulations governing personal data collection, use, and disclosure, that differ from
              United States laws, you are transferring your personal data to the United States which
              may not have the same data protection laws as such other regions.
            ...
            <p className="pb-4">
              Pursuant to Section 1798.83 of the California Civil Code, residents of California can
              obtain certain information about the types of personal information that companies with
              whom they have an established business relationship have shared with third parties for
              direct marketing purposes during the preceding calendar year. In particular, the law
              provides that companies must inform consumers about the categories of personal
              information that have been shared with third parties, the names and addresses of those
              third parties, and examples of the types of services or products marketed by those
              third parties. To request a copy of the information disclosure provided by Gamisodes
              pursuant to Section 1798.83 of the California Civil Code, please contact us via the
              email address stated below. Please allow at least 30 days for a response.
            </p>
            <p className="pb-4 text-2xl">
            ...
            <p className="pb-4">
              ...
              website or application notifying users of the changes. In some cases, we also may send
              an email notifying users of any changes.
            ...
            <p className="pb-4">
              ...
              <span className="Apple-converted-space">&nbsp; </span>If you have any questions about
              this Privacy Policy, the practices of this site, or your dealings with this site,
              please contact us at hello@gamisodes.com.
            </p>
          </div>
        </div>
      </VStack>
