...
export function useCollectionMainInterface({
  BlockchainCollections,
  Dapper: { collection: DapperCollection, isSuccess: isSuccessDapper },
  NiftoryCustodial: { collection: CustodialCollection, isSuccess: isSuccessCustodial },
  ...
  useEffect(() => {
    ...
    DapperCollection?.pages,
    CustodialCollection?.pages,
    isSuccessDapper,
    isSuccessCustodial,
    BlockchainCollections,
  ])
